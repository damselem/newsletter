namespace :development do
  ...
  task :create_fake_email => :environment do
    ...
    email = JSON.parse(File.read(file))

    user = User.create(:first_name => Faker::Name.first_name, :last_name => Faker::Name.last_name, :email => Faker::Internet.email, :provider => 'google', :uid => rand(0..9999))
